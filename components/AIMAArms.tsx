    ...
    <section id="arms" style={{ padding: '96px 32px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div className="arms-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
          ...
          {/* Card 1 — spans cols 1-2, row 1 */}
          <BentoCard index={0} accent="gold"
            title="Arm 01 · Voice Management"
            subtitle="Designed to answer, triage, and route every inbound call according to business-defined rules. Built so no call goes unanswered regardless of volume or time of day — replacing the capacity ceiling of human front-desk staff."
          ...
          <BentoCard index={2}
            ...
            subtitle="Designed to qualify every inbound lead against your criteria within seconds of contact, then route or follow up automatically. Replaces the need for manual SDR overhead for high-volume pipelines."
            badge="IN DEVELOPMENT" badgeVariant="muted"
          />
          ...
          <BentoCard index={3}
            ...
            subtitle="A unified data layer connecting your CRM, scheduling, communication, and finance tools. AIMS maintains a single source of truth across all platforms — eliminating manual sync and data entry."
            badge="IN DEVELOPMENT" badgeVariant="muted"
          >
          ...
          <BentoCard index={4}
            ...
            subtitle="Call outcomes, lead conversion, revenue flow, and operational performance — all surfaced in one auditable interface. Built to give business owners the single view they currently lack."
            badge="IN DEVELOPMENT" badgeVariant="muted"
          >
            <Sparkline />
          </BentoCard>

          {/* Card 6 — spans cols 2-3, row 2 */}
          <BentoCard index={5} accent="gold"
            title="Arm 06 · Outbound & Closing"
            subtitle="Manages follow-up sequences autonomously — moving leads through the pipeline without manual intervention. Designed to close the gap between a qualified lead and a signed agreement."
            badge="IN DEVELOPMENT" badgeVariant="muted"
          ...
          <div className="strip-inner" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '24px' }}>
            <div>
              ...
              <p style={{ fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'var(--muted)', lineHeight: 1.7 }}>
                We are selecting early access partners ahead of launch. Integration partners receive priority onboarding and founding-tier pricing locked for life.
              </p>
            </div>
            <motion.button
              onClick={onApply}
